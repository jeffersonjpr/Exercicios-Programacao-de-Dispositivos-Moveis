...
class ThemeController extends GetxController {
  ...
  loadThemeMode() async {
    ...
    // prefs = await SharedPreferences.getInstance(); //recupera a instancia do SharedPreferences
    //String themeText = prefs.getString('theme') ?? 'dark'; //pega o texto do tema ou coloca o padrão dark (se não houver nenhuma)
